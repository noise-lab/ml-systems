...
* [Intro to Naïve Bayes](https://sebastianraschka.com/Articles/2014_naive_bayes_1.html)
* [Naïve Bayes with Jupyter Notebook Example](https://dataaspirant.com/2017/02/06/naive-bayes-classifier-machine-learning/)
* [Naïve Bayes (YouTube)](https://dataaspirant.com/2017/02/06/naive-bayes-classifier-machine-learning/)
* [SVM Intro (YouTube, Stanford)](https://www.youtube.com/watch?v=mTyT-oHoivA)
* [SVM Intro (YouTube, Statquest)](https://www.youtube.com/watch?v=efR1C6CvhmE)
* [Random Forest Background (YouTube)](https://www.youtube.com/watch?v=J4Wdy0Wc_xQ)
* [Random Forest/Ensemble Background](https://machinelearningmastery.com/bagging-and-random-forest-ensemble-algorithms-for-machine-learning/)
* [Advantages/Disadvantages of RF](https://theprofessionalspoint.blogspot.com/2019/02/advantages-and-disadvantages-of-random.html)
* [Hidden Markov Models (YouTube)](https://www.youtube.com/watch?v=LdPaXoy9w6E)
* [Neural Network Playground](https://playground.tensorflow.org/)

### Unsupervised Learning
* [Choosing k in k-means](https://towardsdatascience.com/clustering-metrics-better-than-the-elbow-method-6926e1f723a6)
* [Intro to KDE (YouTube)](https://www.youtube.com/watch?v=x5zLaWT5KPs)
* [Explanation of Density Estimation from sklearn docs](https://scikit-learn.org/stable/modules/density.html)
* [1D KDE Clustering Example](https://stackoverflow.com/questions/35094454/how-would-one-use-kernel-density-estimation-as-a-1d-clustering-method-in-scikit)
* [Mixture Models Background](https://stephens999.github.io/fiveMinuteStats/intro_to_mixture_models.html)
* [Intro to EM (YouTube)](https://www.youtube.com/watch?v=REypj2sy_5U)
* [EM Intro](https://stephens999.github.io/fiveMinuteStats/intro_to_em.html)
* [Using PCA, Visualizing PCA Results](https://blog.bioturing.com/2018/06/14/principal-component-analysis-explained-simply/)

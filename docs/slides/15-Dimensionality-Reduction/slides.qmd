...
In practice the PCs are the eigenvectors of the data's covariance matrix, ranked by
eigenvalue — the variance each one captures. *(Algorithm and equations in the appendix.)*

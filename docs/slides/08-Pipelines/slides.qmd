...
**The threshold itself is a tuning knob:** some problems demand high detection even at
the cost of more false positives (or vice versa). Evaluate the classifier across the
range of thresholds, then pick the **operating point** that matches your cost tradeoff.
...
Threshold/operating-point selection (original slide 19): a medical screen or a
mission-critical IDS may deliberately run at a low threshold to maximize recall,
accepting more false alarms; a system feeding scarce analyst attention may do the
opposite. The ROC and PR curves show all achievable operating points at once.
:::
